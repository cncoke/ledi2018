 ...
 */
package io.yc.library.httpokgo.adapter;

import io.yc.library.httpokgo.cache.CacheEntity;
import io.yc.library.httpokgo.cache.policy.CachePolicy;
import io.yc.library.httpokgo.cache.policy.DefaultCachePolicy;
import io.yc.library.httpokgo.cache.policy.FirstCacheRequestPolicy;
import io.yc.library.httpokgo.cache.policy.NoCachePolicy;
import io.yc.library.httpokgo.cache.policy.NoneCacheRequestPolicy;
import io.yc.library.httpokgo.cache.policy.RequestFailedCachePolicy;
