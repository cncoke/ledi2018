...
import io.yc.library.httpokgo.exception.ResultException;
import io.yc.library.httpokgo.model.BaseResult;
import io.yc.library.httpokgo.utils.Convert;
...
public class JsonConvert<T> implements Converter<T> {
    ...
    private T parseParameterizedType(Response response, ParameterizedType type) throws Exception {
        ...
        if (rawType != BaseResult.class) {
            ...
            BaseResult lzyResponse = Convert.fromJson(jsonReader, type);
            response.close();
            int code = lzyResponse.getStatus();
