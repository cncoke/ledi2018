...
import io.yc.library.httpokgo.db.CacheManager;
import io.yc.library.httpokgo.exception.HttpException;
import io.yc.library.httpokgo.model.Response;
import io.yc.library.httpokgo.request.base.Request;
import io.yc.library.httpokgo.utils.HeaderParser;
...
public abstract class BaseCachePolicy<T> implements CachePolicy<T> {
    ...
    protected void runOnUiThread(Runnable run) {
        HttpRequestUtils.getInstance().getDelivery().post(run);
    }
